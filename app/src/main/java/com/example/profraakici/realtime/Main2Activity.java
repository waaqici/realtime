...
public class Main2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   TextView e=(TextView)findViewById(R.layout.nav_header_main2.id);
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        s = sh.getString("userphone", "defaultValue");

        //  TextView e=(TextView)findViewById(R.id.txtname);
        ...
        // TextView e=(TextView) view.findViewById(R.id.txtnames);


        textView2.setText("ahmed");
